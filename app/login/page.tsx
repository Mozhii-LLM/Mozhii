    ...
    <div className="w-full max-w-md space-y-8">
      ...
      <div className="mt-6">
        ...
        <div className="mt-6">
          <button
            onClick={googleLogin}
            className="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0B0377]"
          >
